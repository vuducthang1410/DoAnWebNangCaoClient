      ...
      <div className="bg-slate-700 rounded-2xl grid-cols-2 grid max-lg:grid-cols-1 box-container">
        ...
        <div className="bg-white flex flex-col justify-center items-center p-10 rounded-r-2xl max-lg:rounded-2xl">
          <div className="flex flex-col mr-auto mt-2 mb-5">
            ...
            <label className="font-bold text-xl">Welcome to Hygge</label>
          </div>
          <div className="mb-10">
            <label className="font-bold text-xl text-violet-700">Login</label>{" "}
            <label className="font-semibold text-lg text-gray-700">
              your account
            </label>
          </div>
          {inputFields.map((item, index) => (
            <div key={index} className="relative h-10 mt-3">
              <input
                className="px-1 py-0 input-signup outline-none border-b w-72 border-b-slate-700 bg-transparent"
                id={item.id}
                name={item.name}
          ...
          <div className="flex justify-center items-center">
            ...
            <span className="m-1 my-1 text-slate-500 font-semibold text-sm">
              OR
            </span>
            <div className="h-px bg-slate-400 w-28"></div>
          </div>
          ...
          <button className="flex justify-center items-center  bg-violet-600 w-72 h-10 rounded-md font-bold text-base text-white m-1">
            <svg
              className="h-6 w-6 mr-2"
              xmlns="http://www.w3.org/2000/svg"
              xmlnsXlink="http://www.w3.org/1999/xlink"
          ...
          <div className="mt-2 mb-1">
            <label href="">Create account?</label>
            <a className=" text-violet-600 ml-1 font-semibold" href="/signup">
              Sign up
            </a>
          </div>
        </div>
